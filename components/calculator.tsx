...
export default function Calculator() {
  ...
  // Function to perform modulus and set the result
  const modulus = (): void => {
    setResult((parseFloat(num1) % parseFloat(num2)).toString());
  };
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100 dark:bg-gray-900 " >
      ...
      <Card className="w-full max-w-md p-6 bg-gray-200 dark:bg-gray-800 shadow-lg rounded-lg">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-2">
            <Button
              variant="outline"
              className="text-2xl font-bold text-gray-700 dark:text-gray-300 bg-blue-500"
              onClick={add}
            >
              +
            </Button>
          ...
          <Button variant="outline" className="w-full bg-blue-500" onClick={clear}>
            Clear
          </Button>
        </CardContent>
      </Card>
